    ...
    <div class="profile">
        ...
        <div class="sections">
            ...
            <div class="right-col">
                ...
                <div class="mobile-navbar">
                    ...
                    <div class="accounts accounts-mob">
                        ...
                        <span v-if="notifications.length" style="position: relative;">
                            ...
                            <div
                                style="height: 10px; width:10px; display:inline; background-color: red; border-radius: 50%;position:  absolute; z-index:999; top:-2px">
                ...
                <div class="row-one">
                    ...
                    <div class="accounts accounts-lg">
                        <span v-if="notifications.length" style="position: relative;" class="active">
                            <div><i class="fa-solid fa-bell "></i></div>
                            <div
                                style="height: 15px; width:15px; display:inline; background-color: red; border-radius: 50%;position:  absolute; z-index:999; top:-2px">
                                {{ notifications.length }}</div>
                            <div class="dropdown"
                                style="position: absolute; width: 170px; margin-left: -70px; background-color: #504DFF; color:white;padding: 2px;">
                                <div v-for="(notification, idx) in notifications" :key="idx">
                                    <p @click="clearNotice(idx)">{{ notification }}</p>
                                </div>
                            </div>
                ...
                <div class="view-area" style="display: flex; flex-direction: row; align-items: center
                max-width:100%;">
                    <div style="width:40%">
...
ChartJS.register(ArcElement, BarElement, PointElement, LineElement, Title, Tooltip, Legend, BarElement, CategoryScale, LinearScale)
